...
<body class="font-sans flex flex-col min-h-screen antialiased dark:bg-black dark:text-white/50">
    <!-- Navbar -->
    ...
    <main class="flex-grow">
        ...
        <section class="bg-gradient-to-r from-blue-600 to-indigo-700">
            <div
                class="max-w-screen-xl h-fit lg:h-screen mx-auto px-4 py-24 lg:flex lg:items-center lg:justify-between">
                <div class="max-w-2xl">
                    ...
                    <div class="p-8 bg-white rounded-xl cursor-default hover:shadow-xl transition-shadow duration-300">
                        <div class="flex items-center justify-center w-14 h-14 bg-blue-50 rounded-xl">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                class="lucide lucide-telescope w-8 h-8 text-blue-600">
                                <path
                    ...
                    <div class="p-8 bg-white rounded-xl cursor-default hover:shadow-xl transition-shadow duration-300">
                        <div class="flex items-center justify-center w-14 h-14 bg-green-50 rounded-xl">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-code w-8 h-8 text-green-600">
                    ...
                    <div class="p-8 bg-white rounded-xl cursor-default hover:shadow-xl transition-shadow duration-300">
                        <div class="flex items-center justify-center w-14 h-14 bg-yellow-50 rounded-xl">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-notebook-pen w-8 h-8 text-yellow-300">
                        ...
                        <div class="flex gap-x-5 sm:gap-x-8">
                            ...
                            <span
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="lucide lucide-move-diagonal-2 shrink-0 size-5">
                                    <path d="M19 13v6h-6" />
                                    <path d="M5 11V5h6" />
                                    <path d="m5 5 14 14" />
                                </svg>
            ...
            <div class="max-w-screen-xl mx-auto px-4">
                ...
                <div class="swiper-container w-full h-[400px] md:h-[500px] mt-14 slider-testimonials  overflow-hidden">
                    <div class="swiper-wrapper flex w-full h-full" id="portfolio-swiper-wrapper">
                        ...
                        <div class="swiper-slide cursor-pointer">
                            <div class="p-8 bg-white rounded-xl shadow-lg h-fit">
                                ...
                                <p class="text-gray-600 leading-relaxed text-center text-content-swipper hidden">
                                    "This platform has completely transformed how I build websites. The tools are
                                    intuitive
                        ...
                        <div class="swiper-slide cursor-pointer ">
                            <div class="p-8 bg-white rounded-xl shadow-lg h-fit">
                                ...
                                <p class="text-gray-600 leading-relaxed text-center text-content-swipper hidden">
                                    "I've never worked with a more efficient and customizable framework. It's a
                                    game-changer
                    ...
                    <div class="relative w-full">
                        <div
                            class="absolute h-10 bottom-6 left-0 right-4 flex items-center justify-end space-x-2 z-10">
