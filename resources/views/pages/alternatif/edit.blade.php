...
@section('mobile-breadcrumb')
    <li class="flex items-center text-sm text-gray-800 dark:text-neutral-400">
        <a href="{{ route('alternatif.index') }}" class="inline-flex items-center">
            Alternatif
        ...
        <form action="{{ route('alternatif.update', $alternatif->id_alternatif) }}" method="POST">
            ...
            <div
                ...
                <div class="sm:col-span-3">
                    <label for="af-submit-application-aspek-nip"
                ...
                <div class="sm:col-span-9">
                    <div class="sm:flex">
                        <input id="af-submit-application-aspek-nip" name="nip" type="text"
                ...
                <div class="sm:col-span-9">
                    <input id="af-submit-application-name" name="name" type="text" value="{{ $alternatif->name }}"
                        class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                </div>
                <!-- End Col -->
