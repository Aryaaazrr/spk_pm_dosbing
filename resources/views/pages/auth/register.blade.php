<x-guest-layout>
    ...
    <div class="flex flex-col items-center justify-center">
        <div class="w-9/12 py-4">
            <h1 class="text-center font-bold text-2xl"> {{ __('Create Account') }}</h1>
            <p class="text-center py-2"> {{ __('Enter your account below to register your new account') }}</p>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex items-center justify-center mt-4">
            <p class="me-2">{{ __('Already Have Account?') }}</p>
