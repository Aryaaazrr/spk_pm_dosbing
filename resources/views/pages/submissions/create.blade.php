                ...
                <div class="max-w-[50rem] flex flex-col mx-auto size-full">
                    ...
                    <main id="content">
                        <div class="text-center flex flex-col justify-center items-center py-10 px-4 sm:px-6 lg:px-8">
                            ...
                            <p class="text-gray-600 dark:text-neutral-400">Maaf, pengajuan judul belum dibuka, silahkan hubungi Admin.</p>
                    ...
                    <footer class="mt-auto text-center py-5">
                        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
                            <p class="text-sm text-gray-500 dark:text-neutral-500">©SPK_DOSBING All Rights Reserved. 2025.</p>
                        </div>
                    </footer>
                </div>
            @else
